// Player 1 - Offence Robot A - Challenge
...
int main()
{
    ...
    image_processing_additional(tvalue, rgb, rgb0, a, b); //image processsing written by Sophia
    ...
    wait_for_player(); //waits for player 2 to join
